...
const WatchLater = () => {
    const { isLoggedIn, watchLater, login } = useVideoStore();
    ...
    return (
        <div className="min-h-screen bg-[var(--bg-primary)]">
            ...
            <main className="lg:pl-60 pt-14 p-4 lg:p-8">
                <h1 className="text-[var(--text-primary)] text-3xl font-bold mb-6 mt-4">Watch later</h1>
                ...
                {!isLoggedIn ? (
                    <div className="flex flex-col items-center justify-center mt-20 gap-4">
                        ...
                        <h2 className="text-[var(--text-primary)] text-xl font-medium">Keep track of what you want to watch</h2>
                        <p className="text-[var(--text-secondary)]">Sign in to access videos you've saved for later</p>
                        <button
                            onClick={login}
                    ...
                    <div className="flex flex-col items-center justify-center mt-20 gap-4">
                        ...
                        <p className="text-[var(--text-secondary)] text-lg">Your Watch later list is empty.</p>
                    </div>
                )}
            </main>
        </div>
